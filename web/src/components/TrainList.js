...
import { getReservations, deleteReservation ,trains} from '../Services'
...
class Reservations extends Component {
    ...
    updateReservations = () => {
        ...
        if (!user) {
            ...
            trains()
                .then(res => {
                    console.log("🚀 ~ file: TrainList.js:39 ~ Reservations ~ res:", res)
                    ...
                    <Row style={{ width: '75%' }} key={number}>
                        <Col>
                            <Card style={{ padding: 10, marginTop: 10 }}>
                                <Row>
                                    <Col>Train No : {reservation._id}</Col>
                                </Row>
                                <hr />
                                <Row>
                                    <Col>Train Name : {reservation.name}</Col>
                                </Row><Row>
                                    <Col >Schedule : {reservation.schedule}</Col>
                                </Row>
                                {/* <Row>
                                ...
                                <Row>
                                    <Col style={{ paddingTop: 10 }} align='right'>
                                        <Button variant="danger" size="sm" onClick={() => this.cancelReservation(reservation._id)}>Delete</Button>
                                    </Col>
                                </Row>
                            </Card>
                        </Col>
            ...
            <Row style={{ alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                {this.state.reservations.length <= 0 &&
                    <Row style={{ width: '75%', padding: 10 }}>
                        <Col>
                            <Card>
                                <Card.Body>You don't have any trains yet!!!</Card.Body>
                            </Card>
                        </Col>
                    </Row>
                }
